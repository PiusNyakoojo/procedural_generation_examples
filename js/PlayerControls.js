...
THREE.PlayerControls = function ( camera, player, domElement ) {
	...
	this.init = function( angle ) {
		...
		this.camera.position.x = this.distance * Math.sin( this.player.rotation.y );
		this.camera.position.z = this.distance * Math.cos( this.player.rotation.y );
	...
	this.update = function() { 
		...
		if ( this.autoRotate ) {
			...
			this.camera.position.x += this.autoRotateSpeed * ( ( this.player.position.x + this.distance * Math.sin( this.player.rotation.y ) ) - this.camera.position.x );
			this.camera.position.z += this.autoRotateSpeed * ( ( this.player.position.z + this.distance * Math.cos( this.player.rotation.y ) ) - this.camera.position.z );
